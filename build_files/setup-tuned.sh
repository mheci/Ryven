...
systemctl enable tuned.service nohang-desktop.service scx_lavd.service
...
systemctl mask systemd-zram-setup@zram0.service zram-swap.service dev-zram0.swap 2>/dev/null || true
